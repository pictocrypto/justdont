...
var requiredParam = require('./required-param-e338a200.cjs.prod.js');
var reactQuery = require('@tanstack/react-query');
var ethers = require('ethers');
var invariant = require('tiny-invariant');
var useConnect = require('./useConnect-14d2ac94.cjs.prod.js');
...
const WrappedThirdwebSDKProvider = _ref => {
  ...
  React.useEffect(() => {
    ...
    const _sdk = new sdk.ThirdwebSDK(provider, sdkOptions, storageInterface); // if we already have a signer from the wallet context, use it immediately
...
function useUnclaimedNFTs(contract, queryParams) {
  ...
  return useQueryWithNetwork(cacheKeys.contract.nft.drop.getAllUnclaimed(contractAddress, queryParams), () => {
    requiredParam.requiredParamInvariant(contract, "No Contract instance provided"); // TODO make this work for custom contracts (needs ABI change)
...
function useAcceptDirectListingOffer(contract) {
  ...
  return reactQuery.useMutation(async data => {
    invariant__default["default"](walletAddress, "no wallet connected, cannot make bid");
    requiredParam.requiredParamInvariant(contract === null || contract === void 0 ? void 0 : contract.direct, "No Direct instance provided");
...
function useExecuteAuctionSale(contract) {
  ...
  return reactQuery.useMutation(async data => {
    invariant__default["default"](walletAddress, "no wallet connected, cannot make bid");
    requiredParam.requiredParamInvariant(contract === null || contract === void 0 ? void 0 : contract.auction, "No Auction marketplace instance provided");
...
function useActiveClaimConditionForWallet(contract, walletAddress, tokenId) {
  ...
  return useQueryWithNetwork(cacheKeys.extensions.claimConditions.useActiveClaimConditionForWallet(contractAddress, walletAddress || "_NO_WALLET_", tokenId), async () => {
    ...
    const normalizedPrize = price ? ethers.utils.parseUnits(price, currencyMetadata.decimals) : null;
